    ...
    def _set_zone(self, zone):
        if zone == Zone.PLAY:
            if self.owner and hasattr(self.owner, 'buffs'):
                ...
                self.logger.warning("Enchantment %r has no valid owner when entering PLAY zone", self)
            ...
            if self.zone == zone:
                ...
                return
            if self.owner and hasattr(self.owner, "health"):
            ...
            if old_health is not None and self.owner and hasattr(self.owner, "health"):
