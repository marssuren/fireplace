...
class DMF_004:
    ...
    # 10费 7/5 - 战吼：如果你在本局对战中施放过10个法术，旋转尤格-萨隆之轮
...
class DMF_188:
    ...
    # 10费 10/10 - 战吼：将你在本局对战中打出的每张已腐蚀的卡牌的一张复制置入你的手牌。在本回合中，这些卡牌的法力值消耗为(0)点
...
class DMF_254:
    ...
    # 10费 6/6 - 游戏开始时：分裂成碎片。战吼：随机对所有敌方角色造成总共30点伤害
...
class YOP_018:
    ...
    # 5费 4/5 - 战吼：发现一张任意职业的双职业法术。法术迸发：再获取一张该法术的复制
